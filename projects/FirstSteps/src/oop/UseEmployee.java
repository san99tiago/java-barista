...
//		testEmployees1();
	...
	public static void testEmployees1() {
		...
		Employee employee_1 = new Employee("Santiago Garcia", 100, 2021, 07, 28);
		Employee employee_2 = new Employee("Santiago Mendez", 150, 2022, 12, 15);
		Employee employee_3 = new Employee("Leonardo Davinci", 1200, 2025, 01, 01);
	...
	public static void testEmployees2() {
		...
		employees[0] = new Employee("Santiago Garcia", 100, 2021, 07, 28);
		employees[1] = new Employee("Santiago Mendez", 150, 2022, 12, 15);
		employees[2] = new Employee("Leonardo Davinci", 1200, 2025, 01, 01);
